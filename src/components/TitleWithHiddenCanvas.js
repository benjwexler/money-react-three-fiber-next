    ...
    <>
      <ShowIf condition={hiddenBillRef?.current}>
        <div className="title-container">
          <div
            className="page1-title-container"
            style={{ marginLeft: titlePosition.x > 60 ? titlePosition.x : 60 }}
          >
      ...
      <Canvas frameloop="demand" className="canvas" camera={cameraInfo}>
        <TitlePosition
          hiddenBillRef={hiddenBillRef}
